...
function setMap() {
  ...
  var tian_di_tu_road_layer = new ol.layer.Tile({
    ...
    source: new ol.source.XYZ({
      url:
        'http://t3.tianditu.com/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=f1a5b2c434607d3ebf3552166c3b4dc3'
    })
  });
  ...
  var tian_di_tu_annotation = new ol.layer.Tile({
    ...
    source: new ol.source.XYZ({
      url:
        'http://t3.tianditu.com/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=f1a5b2c434607d3ebf3552166c3b4dc3'
    })
  });
  ...
  layerCheck.click(function(event, data) {
    // 点击切换图层显示
    var name = $(this)
      .parent()
      .text()
  ...
  dragBox.on('boxend', function() {
    ...
    dragRect.addFeature(
      new ol.Feature(
        new ol.geom.LineString([[extent[0], extent[1]], [extent[0], extent[3]]])
      )
    );
    dragRect.addFeature(
      new ol.Feature(
        new ol.geom.LineString([[extent[0], extent[1]], [extent[2], extent[1]]])
      )
    );
    dragRect.addFeature(
      new ol.Feature(
        new ol.geom.LineString([[extent[0], extent[3]], [extent[2], extent[3]]])
      )
    );
    dragRect.addFeature(
      new ol.Feature(
        new ol.geom.LineString([[extent[2], extent[1]], [extent[2], extent[3]]])
      )
    );
